...
void BergerNeighborInfo::copy(const BergerNeighborInfo& other)
{
    ...
    this->gw1_var = other.gw1_var;
    this->gw2_var = other.gw2_var;
}
...
void BergerNeighborInfo::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->gw1_var);
    doPacking(b,this->gw2_var);
}
...
void BergerNeighborInfo::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->gw1_var);
    doUnpacking(b,this->gw2_var);
}
...
IPv4Address& BergerNeighborInfo::getGw1()
{
    return gw1_var;
}

void BergerNeighborInfo::setGw1(const IPv4Address& gw1)
{
    this->gw1_var = gw1;
}

IPv4Address& BergerNeighborInfo::getGw2()
{
    return gw2_var;
}

void BergerNeighborInfo::setGw2(const IPv4Address& gw2)
{
    this->gw2_var = gw2;
}
...
int BergerNeighborInfoDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='g' && strcmp(fieldName, "gw1")==0) return base+3;
    if (fieldName[0]=='g' && strcmp(fieldName, "gw2")==0) return base+4;
...
std::string BergerNeighborInfoDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: {std::stringstream out; out << pp->getGw1(); return out.str();}
        case 4: {std::stringstream out; out << pp->getGw2(); return out.str();}
        default: return "";
    }
}
...
void *BergerNeighborInfoDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return (void *)(&pp->getGw1()); break;
        case 4: return (void *)(&pp->getGw2()); break;
        default: return NULL;
    }
}
