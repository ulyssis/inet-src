...
class INET_API IPv4 : public QueueBase
{
  ...
  protected:
     ...
     */
    virtual void routeUnicastPacket(IPv4Datagram *datagram, InterfaceEntry *destIE, IPv4Address nextHopAddr, double txp);

    /**
     * Broadcasts the datagram on the specified interface.
     * When destIE is NULL, the datagram is broadcasted on each interface.
     */
    virtual void routeLocalBroadcastPacket(IPv4Datagram *datagram, InterfaceEntry *destIE, double txp);
     ...
     */
    virtual void forwardMulticastPacket(IPv4Datagram *datagram, InterfaceEntry *fromIE, double txp);
     ...
     */
    virtual void fragmentAndSend(IPv4Datagram *datagram, InterfaceEntry *ie, IPv4Address nextHopAddr, double txp);

    /**
     * Last TTL check, then send datagram on the given interface.
     */
    virtual void sendDatagramToOutput(IPv4Datagram *datagram, InterfaceEntry *ie, IPv4Address nextHopAddr, double txp);
