...
void Radio::handleLowerMsgEnd(AirFrame * airframe)
{
    ...
    if (snrInfo.ptr == airframe)
    {
        ...
        snrBerger = airframe->getSnr(); // Di
        lossRateBerger = airframe->getLossRate(); //Di
        sendUp(airframe);
    }
...
//double Radio::getSnrBerger()
//    {
//
//    //    if (!snrInfo.sList.size())
////        {return snrInfo.sList.end()->snr;}
////    else
////        return 0;
//
////        snrBerger = snrInfo.sList.end()->snr; // Di
//    }
